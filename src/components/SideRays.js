...
void main() {
  ...
  gl_FragColor = color;
      ...
      /* Reduced motion still gets the light, just not the drift: one frame is
         rendered and the loop never asks for another. */
      ...
      const loop = t => {
        ...
        try {
          ...
          if (!stillFrame) animationIdRef.current = requestAnimationFrame(loop);
        } catch (e) {
          return;
        }
      };
